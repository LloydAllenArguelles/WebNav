document.addEventListener('DOMContentLoaded', () => {
    ...
    function fetchSchedules(date) {
        ...
        const url = `/../public/includes/fetch_schedules_gca.php?date=${encodeURIComponent(date)}&stat=${encodeURIComponent(selectedStatus)}`;
    ...
    calendarDates.addEventListener('click', (event) => {
        ...
        if (target.classList.contains('calendar-date') && target.dataset.date) {
            ...
            const selectedStatus = document.getElementById('stat').value;
            const url = `/../public/includes/fetch_schedules_gca.php?date=${encodeURIComponent(selectedDate)}&stat=${encodeURIComponent(selectedStatus)}`;
            console.log(`Request URL: ${url}`);
    ...
    if (selectedDate) {
        ...
        const url = `/../public/includes/fetch_schedules_gca.php?date=${encodeURIComponent(selectedDate)}`;
    ...
    const xhr = new XMLHttpRequest();
    const url = '/../public/includes/fetch_schedules_gca.php';
