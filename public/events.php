...
<body>
    ...
    <div class="events-container">
        ...
        <div class="events-table">
            <a href="gvevents.php" class="event-button"><i class="fas fa-building"></i> Gusaling Villegas</a>
            <a href="geevents.php" class="event-button"><i class="fas fa-building"></i> Gusaling Ejercito</a>
            <a href="gcaevents.php" class="event-button"><i class="fas fa-building"></i> Gusaling Aquino</a>
        </div>
